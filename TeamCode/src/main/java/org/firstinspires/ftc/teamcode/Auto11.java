 ...
 */
@Autonomous(name = "Red: Shoot/1 Beacon", group = "Red Autonomous")
public class Auto11 extends OpMode {
    int control = 2, target, startDegrees, targetDegrees, correcting = 0, seconaryDegrees;
    DcMotor frontLeft;
    DcMotor frontRight;
    DcMotor backLeft;
    DcMotor backRight;
    ...
    public void loop()
    {
        ...
        switch (control)
        {
            ...
            case 12: {//attempt to lineup
                ...
                if (sonar.getUltrasonicLevel() <= 15 && sonar.getUltrasonicLevel() > 0) {
                    control = 13;
                    segmentTime = time;
                }

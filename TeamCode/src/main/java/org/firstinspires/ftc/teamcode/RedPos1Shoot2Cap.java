 ...
 */
@Autonomous(name = "Red Pos 1: Shoot 2/Hit cap ball/Park on center", group = "Red Autonomous2")
public class RedPos1Shoot2Cap extends OpMode {
    int  target, startDegrees, targetDegrees, shooterStartPos, rotateDegrees;
    DcMotor frontLeft;
    DcMotor frontRight;
    DcMotor backLeft;
    DcMotor backRight;
    ...
    public enum RobotSteps {ALIGN,SPIN,INIT_START, DELAY, INIT_MOVE, MOVE_TO_SHOOT, INIT_SHOOT, SHOOT, RETURN, PARK, ALL_DONE, SWEEPER_MOVE_BACKWARD, SWEEPER_MOVE_FORWARD, SHOOT_DOS};
    ...
    public void loop()
    {
        ...
        switch (control)
        {
            ...
            case RETURN: {//move forward to knock off cap ball
                if (navigateTime(180, .5, 1800, heading))
            ...
            case PARK: {//park
                if (navigateTime(180, .5, 800, heading))
                    control = RobotSteps.ALL_DONE;
                break;
            }
            /*case PARK: {//park on center
                if (navigateTime(180, .5, 2500, heading))
                    control = RobotSteps.ALL_DONE;
                break;
            }*/

 ...
 */
@Autonomous(name = "Blue: Shoot/Park on Ramp", group = "Blue Autonomous")
@Disabled
public class Auto8 extends OpMode {
    ...
    public void loop()
    {
        ...
        switch (control)
        {
            ...
            case 9: {
                if (navigateTime(0, .6, 2000, heading))
                    control = 10;
                break;
            }
            case 10: {
            ...
            case 11: {
                if (navigateTime(300, .6, 1000, heading))
                    control = 12;
                break;
            }

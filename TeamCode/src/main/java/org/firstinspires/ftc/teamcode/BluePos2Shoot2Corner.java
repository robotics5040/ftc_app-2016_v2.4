 ...
 */
@Autonomous(name = "Red Pos 2: Shoot 2/Park on corner", group = "Red Autonomous2")
public class BluePos2Shoot2Corner extends OpMode {
    ...
    public void loop()
    {
        ...
        switch (control)
        {
            ...
            case MOVE_TO_CORNER: {
                if (navigateTime(285, .5, 2900, heading))

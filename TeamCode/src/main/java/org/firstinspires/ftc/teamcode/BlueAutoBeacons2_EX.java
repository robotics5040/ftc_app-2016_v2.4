 ...
 */
@Autonomous (name = "Blue pos 1: Shoot 1/Press 1.3 EX", group = "Blue Autonomous")
public class BlueAutoBeacons2_EX extends OpMode {
    ...
    int[] beaconPos1 = {1440, -500}, beaconPos2 = {1440, 700};//{x, y}
    DcMotor frontLeft;
    DcMotor frontRight;
    DcMotor backLeft;
    DcMotor backRight;
        ...
        switch (control)
        {
            ...
            case ROTATE: {
                if (rotate('r', 180, heading)) {
                    control = RobotSteps.ROTATE_ALIGN;
                    rotateDegrees = 180;
                    allStop();
                }
